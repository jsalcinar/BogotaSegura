...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { CAI: @zone.CAI, coordinate: @zone.coordinate, influx: @zone.influx, name: @zone.name, user_score: @zone.user_score } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { CAI: @zone.CAI, coordinate: @zone.coordinate, influx: @zone.influx, name: @zone.name, user_score: @zone.user_score } }
